...
{
    public SemaphoreSlim WorkersSemaphore { get; private set; } = new SemaphoreSlim(1, 1);
    public SemaphoreSlim FuelStationsRequestsSemaphore { get; private set; } = new SemaphoreSlim(1, 1);
    public SemaphoreSlim AirStationsRequestsSemaphore { get; private set; } = new SemaphoreSlim(1, 1);
    public SemaphoreSlim ChargeStationsRequestsSemaphore { get; private set; } = new SemaphoreSlim(1, 1);
